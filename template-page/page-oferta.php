...
<div class="products-page" class="content-area">
  <main id="main" class="site-main">
    ...
    if (!empty($offer) && isset($offer)) :
      ...
      $button = $offer['button'];
      $empty_products_info = $offer['empty_products_info'];
      ...
      if (!empty($desc) && isset($desc)) : ?>
        <section class="products-page__info container fade-in">
          <?php echo $desc;
...
<section id="products-container-anchor" class="products-page__products-section container" data-delay="200">
          <?php if ($products_query->found_posts) : ?>
          <div class="products-page__products-filters fade-in">
            ...
            <ul class="product-categories remove-ul-styling">
              <li class="product-single-cat js-filter-item">
                <a href="<?php echo get_post_type_archive_link("products"); ?>" class="active" value="<?php echo esc_html("Wszystkie produkty"); ?>">
                  ...
                  <span class="icon">
                    <svg xmlns="http://www.w3.org/2000/svg" width="7.657" height="13.314" viewBox="0 0 7.657 13.314">
                      <path d="M7.071,2.828l-4.95,4.95A1,1,0,1,1,.707,6.364L6.364.707a1,1,0,0,1,1.414,0l5.657,5.657a1,1,0,1,1-1.414,1.414l-4.95-4.95Z" transform="translate(8.071 -0.414) rotate(90)" />
                    </svg>
                  </span>
                </a>
              </li>
          ...
          <div class="posts-container products-page__products-container fade-in" data-delay="100">
            <?php if ($products_query->have_posts()) : ?>
              <ul id="products-container" class="remove-ul-styling products-grid" data-page="<?= get_query_var('paged') ? get_query_var('paged') : 1; ?>" data-max="<?= $products_query->max_num_pages; ?>">
              ...
              <div id="pagination" data-category="-1">
                <?php numeric_pagination($products_query); ?>
              </div>
            <?php else :
              get_template_part('template-parts/content', 'none');
            endif; ?>
          </div>
          <?php elseif ($empty_products_info) :
            echo $empty_products_info;
          endif;?>
        </section>
    <?php endif; ?>
  </main><!-- #main -->
