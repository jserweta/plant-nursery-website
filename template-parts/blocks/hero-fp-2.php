          ...
          <div class="swiper-slide">
            <div class="container">
              <div class="swiper-content">
                <div class="swiper-content__info slide-right">
                  <?php if (!$hero_heading && !$hero_desc):
                    if (!empty($hours) && isset($hours)) : 
                      ...
                      <div class="swiper-content__info-open-hours">
                        <figure class="swiper-content__info-open-hours-figure">
                          <?php echo wp_get_attachment_image($icon, "large"); ?>
                        </figure>

                        <h1 class="swiper-content__info-heading">
                  ...
                  <?php if(!empty($hero_link) && isset($hero_link)): ?>
                    <a href="<?= esc_url($hero_url); ?>" class="smooth-scroll button-green-border swiper-content__info-button" target="<?= esc_attr($hero_url_target); ?>">
                      <!-- js-trigger -->
                      <?= esc_html($hero_url_title); ?>
                    </a>
                  <?php endif; ?>

                  <div class="swiper-content__info-overlay"></div>
                </div>
                <figure class="swiper-content__figure">
